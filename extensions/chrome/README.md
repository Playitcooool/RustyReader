# RustyReader Chrome Extension

Chrome MV3 extension for saving PDFs and readable web pages from the current tab into the local RustyReader desktop app.
...
- Right-click `Save to RustyReader` menu for direct file links, using the last selected collection.
...
- [docs/rustyreader-connector-api.md](/Volumes/Samsung/Projects/paper-reader/extensions/chrome/docs/rustyreader-connector-api.md)
...
4. Select `/Volumes/Samsung/Projects/paper-reader/extensions/chrome/dist/rustyreader-connector`.

The same command also writes `/Volumes/Samsung/Projects/paper-reader/extensions/chrome/dist/rustyreader-connector-v0.1.0.zip`.

## Use it

1. Start the RustyReader desktop connector from `/Volumes/Samsung/Projects/paper-reader`, or run the mock server below.
...
Default token is `rustyreader-dev-token`.
...
From the RustyReader repo root:
...
The exact request and response contract is documented in [docs/rustyreader-connector-api.md](/Volumes/Samsung/Projects/paper-reader/extensions/chrome/docs/rustyreader-connector-api.md).
